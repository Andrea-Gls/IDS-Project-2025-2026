...
public class SupportService {
    ...
    // Propone Call
    @Transactional
    public SupportRequest resolveRequest(Long requestId, Long mentorUserId, String callLink) {
        ...
        req.setMentor(validMentorAssignment); // Assegno "Mario Rossi" come colui che ha risolto
        req.setCallLink(callLink);            // Metto il link (es. Google Meet)
        req.setStatus(RequestStatus.RESOLVED); // Chiudo il ticket
